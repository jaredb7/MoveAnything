...
if MovAny.isClassicWow then 
	...
	m = {
		...
		LoadList = function(self)
			...
			API:AddElement({name = "ObjectiveTrackerFrame", displayName = "Objectives Window", scaleWH = 1}, c)
			...
			qlf = API:AddElement({name = "QuestFrame", displayName = "Quest Offer / Return", runOnce = function()
