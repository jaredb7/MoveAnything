...
local m = {
	...
	LoadList = function(self)
		...
		API:AddElement({name = "Boss2TargetFramePowerBarArt", displayName = "Raid Boss Power Bar 2"}, c)
		API:AddElement({name = "Boss3TargetFrame", displayName = "Raid Boss Health Bar 3", create = "BossTargetFrameTemplate"}, c)
		API:AddElement({name = "Boss3TargetFramePowerBarArt", displayName = "Raid Boss Power Bar 3"}, c)
		API:AddElement({name = "Boss4TargetFrame", displayName = "Raid Boss Health Bar 4", create = "BossTargetFrameTemplate"}, c)
		API:AddElement({name = "Boss4TargetFramePowerBarArt", displayName = "Raid Boss Power Bar 4"}, c)
		API:AddElement({name = "Boss5TargetFrame", displayName = "Raid Boss Health Bar 5", create = "BossTargetFrameTemplate"}, c)
		API:AddElement({name = "Boss5TargetFramePowerBarArt", displayName = "Raid Boss Power Bar 5"}, c)
		...
		API:AddElement({name = "MinimapNorthTag", displayName = "North Indicator", noScale = 1}, c)
		...
		API:AddElement({name = "GuildInstanceDifficulty", displayName = "Guild Group Flag"}, c)
		API:AddElement({name = "QueueStatusMinimapButton", displayName = "Queue Status Button"}, c)
		API:AddElement({name = "MiniMapMailFrame", displayName = "Mail Notification"}, c)
		API:AddElement({name = "MiniMapTracking", displayName = "Tracking Button"}, c)
