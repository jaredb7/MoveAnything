...
MOVANY.PROFILE_RESET_CONFIRM = "Reset all frames in the current profile?"
...
MOVANY.SAVEAS = "Save as"
MOVANY.ADDNEW = "Add new"
MOVANY.DELETE = "Delete"
...
MOVANY.OPTIONTOOLTIP1 = "Enable to show the nudger with the main window\n\nBy default the Nudger is only shown when interacting with frames."
MOVANY.NUDGER1 = "Show Nudger with main window"
MOVANY.OPTIONTOOLTIP2 = "Toggles display of tooltips on/off\n\nPressing Shift when mousing over elements will reverse tooltip display behavior."
MOVANY.SHOWTOOLTIPS = "Show tooltips"
MOVANY.PLAYSOUNDS = "Toggles if MoveAnything should play a sound when opening and closing the main window."
MOVANY.PLAYSOUND = "Play sound"
MOVANY.CLOSEGUIONESC = "Escape key closes main window"
MOVANY.DONSEARCHFRAMENAME = "Disables searching of actual frame names."
MOVANY.DONTSEARCH = "Dont search frame names"
MOVANY.OPTBAGS1 = "Toggles if MoveAnything will hook containers.\n\nThis should be checked if you use another addon to move your bags."
MOVANY.OPTBAGSTOOLTIP = "Disable bag container hook"
MOVANY.HOOKALLOWED = "Toggles if MoveAnything will hook CreateFrame.\n\nRequires reload to take effect."
MOVANY.HOOKALLOWEDNO = "Disable frame creation hook"
MOVANY.DONTSYNCINCOMBAT = "Toggles if MoveAnything will synchronize pending frames when leaving combat.\n\nDisabling this may result in protected frames requiring a manual sync when leaving combat."
MOVANY.DONTSYNCINCOMBATNO = "Disable sync when leaving combat"
MOVANY.SQUARMAP = "Toggles square MiniMap on/off.\n\nHide \"Round Border\" in the \"Minimap\" category to get rid of the overlaying border."
MOVANY.SQUARMAPNO = "Enable square Minimap"
MOVANY.NOMMWP = "Toggles Minimap mousewheel zoom on/off.\n\nRequires reload to take effect."
MOVANY.NOMMWPNO = "Disable Minimap mousewheel zoom"
MOVANY.DISERRORMES = "Toggles printing of error messages on/off."
MOVANY.DISERRORMESNO = "Disable error messages"
MOVANY.RESETPROFILE1 = "Reset profile\n\nResets the profile, deleting all stored frame settings for this profile."
MOVANY.RESETALL1 = "Reset all\n\nReset MoveAnything to default settings. Deletes all frame settings, as well as the custom frame list"
